...
function buildEmailHtml(participant) {
  const {
    ...
    email, phone, subCommittee, profession
  } = participant;
...
<div class="wrapper">
  <div class="header">
    ...
    <h1>GRADA 2026</h1>
    <p>Grand Rassemblement Des Anciens — 27 septembre 2026</p>
  </div>

  <div class="body">
    <p class="greeting">Salam, <strong>${firstName} ${lastName}</strong> 👋</p>
    <p class="intro">
      Votre inscription au <strong>GRADA 2026</strong> a été enregistrée avec succès !
      Nous avons le plaisir de vous compter parmi les participants à ce rassemblement.
    </p>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr><td style="color:#6B7280;">Date</td><td><strong>27 septembre 2026</strong></td></tr>
    ...
    <div class="success-banner">
      ✓ Inscription confirmée — Présentez ce reçu le jour de l'activité
    </div>
